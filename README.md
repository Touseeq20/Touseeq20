...
**AI-focused Computer Science graduate** with expertise in developing and deploying machine learning models for Computer Vision and NLP applications. Proficient in React Native mobile development and advanced AI techniques including RAG, Object Detection, and Segmentation. Experienced in full project lifecycle from data annotation to production deployment in agile team environments.
...
**Machine Learning** | **Deep Learning** | **Computer Vision** | **Natural Language Processing** | **Mobile AI Development**
...
- 🤖 **RAG Document Chatbot** : AI-powered chatbot using Streamlit, FAISS, and HuggingFace for document retrieval, integrated with OpenAI & DeepSeek APIs. Supports multi-document uploads and real-time Q&A
- 🍽️ **Restaurant Menu Website** : Static website built with HTML/CSS/JavaScript

### 🎓 **University Projects**
- 🧑‍💻 **Face Recognition Attendance System** : Python + OpenCV automated attendance system
- 📝 **Next Word Prediction** : NLP model for predicting next words in sentences
- ♟️ **Checkers Game** : C# GUI application with TCP-based client-server communication
...
👉 **[NTC Support Portal](https://dc-support.ntc.org.pk)**  
